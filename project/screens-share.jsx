...
function ShareScreen({ student, nav, fromLog }) {
  ...
  const url = `courttrack.app/p/${student.id}`;
  ...
  return (
    <div style={{ background: '#fff', minHeight: '100%', paddingBottom: 60 }}>
      ...
      <div style={{
        ...
        <div style={{ fontSize: 26, fontWeight: 700, letterSpacing: -0.5, marginTop: 6, lineHeight: 1.15 }}>
      ...
      <div style={{ padding: previewMode ? '20px 0 0' : '20px 20px 0', display: 'flex', flexDirection: 'column', gap: 18 }}>
        ...
        <Card style={{ background: CT.greenSoft, borderColor: `${CT.green}33` }}>
          ...
          <div style={{ fontSize: 18, fontWeight: 700, color: CT.greenDeep, marginTop: 4, letterSpacing: -0.2 }}>
            {student.goal}
          </div>
        </Card>
          ...
          <>
            <div>
              ...
              <Card>
                ...
                <div style={{ fontSize: 20, fontWeight: 700, color: CT.ink, marginTop: 2, letterSpacing: -0.3 }}>
                  {last.focus}
                </div>
              </Card>
            </div>
